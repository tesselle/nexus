...
* Look at the [style guide](https://github.com/tesselle/nexus/blob/master/.github/CODING_STYLE.md) before making changes. Please don't restyle code that has nothing to do with your PR.
...
Please note that the nexus project is released with a [Contributor Code of Conduct](https://github.com/tesselle/nexus/blob/master/.github/CODE_OF_CONDUCT.md). By contributing to this project you agree to abide by its terms.
